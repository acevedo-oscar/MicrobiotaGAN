...
train_ds = pd.read_csv('/media/acevedo/cold/KEEP/ExperimentsDataArchieve/k1_dir/k1_train_set.csv', header=None).values
...
experiment_name = "vainilla_k1" #input() complement_redo_k1
